...
def setup_dataloader(args):
    ...
    """
    # ================== TODO: CODE HERE ================== #
    # Task: Perform some preprocessing to tokenize the text.
    # Create inputs to the CBOW model where each sample
    # in your dataset is the target word and it's corresponding
    # context window.

    # Then split the data into train set and validation set and create respective
    # dataloaders.
    # ===================================================== #
...
def setup_model(args):
    ...
    """
    # ================== TODO: CODE HERE ================== #
    # Task: Initialize your CBOW model.
    # ===================================================== #
    model = None
    return model
...
def setup_optimizer(args, model):
    ...
    """
    # ================== TODO: CODE HERE ================== #
    # Task: Initialize the loss function for predictions. Also initialize your optimizer.
    # ===================================================== #
    criterion = None
    optimizer = None
...
def main(args):
    ...
    if args.downstream_eval:
        word_vec_file = os.path.join(args.outputs_dir, "learned_word_vectors.txt")
